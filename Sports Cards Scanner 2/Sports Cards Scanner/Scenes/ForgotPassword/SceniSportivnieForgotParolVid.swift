...
final class SceniSportivnieForgotParolVid: UIView {
    ...
    lazy var sendButton: SportivinieKartiCommonKnopka = { button in
...
private extension SceniSportivnieForgotParolVid {
