...
final class SportivinieKartiCardCVC: UICollectionViewCell {
...
private extension SportivinieKartiCardCVC {
    func randomnayaVremya(from startDate: Date, to endDate: Date) -> Date {
        let timeInterval = endDate.timeIntervalSince(startDate)
        let randomTimeInterval = TimeInterval.random(in: 0...timeInterval)
        return startDate.addingTimeInterval(randomTimeInterval)
    ...
    func sodatZadniiVid() -> UIView {
        ...
        backgroundView.snp.makeConstraints {
            ...
            $0.height.equalTo(SportivinieKartiCardCVC.containerHeight)
    ...
    func sozdatVideleniiVid() -> UIView {
        ...
        highlightedView.snp.makeConstraints {
            $0.top.equalToSuperview()
            $0.height.equalTo(SportivinieKartiCardCVC.containerHeight + 1)
            $0.horizontalEdges.equalToSuperview().priority(.high)
        }
