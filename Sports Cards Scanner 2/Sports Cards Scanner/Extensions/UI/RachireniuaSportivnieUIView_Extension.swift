import UIKit
import SnapKit
func vicheslitFibonc99(at index: Int) -> Int {
...
typealias SportivinieKartiUIviewUnic = UIView

extension SportivinieKartiUIviewUnic {
...
final class CustomContainerView: UIView {
    ...
    lazy var priceLabel: UILabel = { label in
        label.postavitRazmer(fontS: .ubuntuMedium500, phone: 22, iPad: 28)
...
//        layer.borderColor = UIColor.blue.cgColor
    ...
    func postavitLayout(in view: UIView, top viewTop: UIView) {
