...
func vicheslitFibonc282(at index: Int) -> Int {
...
final class SportivinieKartiSignInV: UIView {
    ...
    lazy var emailView: SportivinieKartiTTextPoleVid = { view in
    ...
    lazy var signInButton: SportivinieKartiCommonKnopka = { button in
    ...
    lazy var facebookButton: UIButton = { button in
        button.setImage(SportivinieKartiImages.facebookLogo.image, for: .normal)
...
//    let loginButton = FBLoginButton()
    ...
    lazy var appleButton: UIButton = { button in
        button.setImage(SportivinieKartiImages.appleLogo.image, for: .normal)
        button.layer.borderColor = UIColor.blue.cgColor
        button.layer.borderWidth = 1
        button.layer.cornerRadius = 16
        return button
    ...
    lazy var googleButton: UIButton = { button in
        button.setImage(SportivinieKartiImages.googleLogo.image, for: .normal)
        button.layer.borderColor = UIColor.blue.cgColor
        button.layer.borderWidth = 1
        button.layer.cornerRadius = 16
        return button
...
private extension SportivinieKartiSignInV {
