...
final class SportivinieKartiGraderViborVc: UIViewController {
...
private extension SportivinieKartiGraderViborVc {
    ...
    func postavitVid() {
        ...
        graderSelectionView.gradersTableView.register(SportivinieKartiGraderTCl.self, forCellReuseIdentifier: SportivinieKartiGraderTCl.className)
...
extension SportivinieKartiGraderViborVc: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: SportivinieKartiGraderTCl.className, for: indexPath) as? SportivinieKartiGraderTCl
...
extension SportivinieKartiGraderViborVc: UITableViewDelegate {
