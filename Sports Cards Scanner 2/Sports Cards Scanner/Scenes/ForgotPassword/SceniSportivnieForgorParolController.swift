...
final class SceniSportivnieForgorParolController: UIViewController {

    // MARK: - Subviews

    lazy var forgotPasswordView: SceniSportivnieForgotParolVid = .init()
    ...
    weak var delegate: SceniSportivnieForgotParolDelegat?
...
private extension SceniSportivnieForgorParolController {
...
extension SceniSportivnieForgorParolController: UITextFieldDelegate {
