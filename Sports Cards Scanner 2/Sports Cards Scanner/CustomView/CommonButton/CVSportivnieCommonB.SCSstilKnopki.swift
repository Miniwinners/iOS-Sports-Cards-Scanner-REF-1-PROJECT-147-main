...
extension SportivinieKartiCommonB.SportivinieKartistilKnopki {
    ...
    private var appearance: SportivinieKartiCommonB.SportivinieKartiVidKnopki {
        switch self {
    ...
    // MARK: - Configurations
    private static let defaultAppearance: SportivinieKartiCommonB.SportivinieKartiVidKnopki = .init(
    ...
    private static let cancel2Appearance: SportivinieKartiCommonB.SportivinieKartiVidKnopki = .init(
    ...
    private static let cancelAppearance: SportivinieKartiCommonB.SportivinieKartiVidKnopki = .init(
        configuration: cancelConfiguration,
        font: .font(.ubuntuRegular400, size: UIDevice.isIpad ? 22 : 16),
    ...
    private static let destructiveAppearance: SportivinieKartiCommonB.SportivinieKartiVidKnopki = .init(
