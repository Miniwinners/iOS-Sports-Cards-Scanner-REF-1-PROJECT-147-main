...
final class SportivinieKartiCurrentValueDetaliController: UIViewController {
...
private extension SportivinieKartiCurrentValueDetaliController {
    func randomnayaVremya(from startDate: Date, to endDate: Date) -> Date {
        let timeInterval = endDate.timeIntervalSince(startDate)
        let randomTimeInterval = TimeInterval.random(in: 0...timeInterval)
        return startDate.addingTimeInterval(randomTimeInterval)
...
extension SportivinieKartiCurrentValueDetaliController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: SCDCurrentValueDetaliCollectionKletka.cellIdentifier, for: indexPath) as? SCDCurrentValueDetaliCollectionKletka else { fatalError() }
...
extension SportivinieKartiCurrentValueDetaliController: UITableViewDelegate {
