...
final class SportivinieKartiVhodController: UIViewController {
...
private extension SportivinieKartiVhodController {
    ...
    func postavidDeistviaUnicalno() {
        ...
        signInView.googleButton.addTarget(self, action: #selector(vhodeCherezGoggleNazhata), for: .touchUpInside)
...
extension SportivinieKartiVhodController: UITextFieldDelegate {
