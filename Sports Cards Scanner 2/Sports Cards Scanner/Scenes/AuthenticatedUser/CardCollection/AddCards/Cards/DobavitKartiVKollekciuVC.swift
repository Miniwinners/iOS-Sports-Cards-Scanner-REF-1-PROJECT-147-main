...
final class DobavitKartiVKollekciuVC: UIViewController {
...
private extension DobavitKartiVKollekciuVC {
    func postavitVid() {
        ...
        addCardsView.cardsCollectionView.register(SportivinieKartiCardPCVC.self, forCellWithReuseIdentifier: SportivinieKartiCardPCVC.className)
...
extension DobavitKartiVKollekciuVC: UITextFieldDelegate {
...
extension DobavitKartiVKollekciuVC: UICollectionViewDataSource {
...
extension DobavitKartiVKollekciuVC: UICollectionViewDelegateFlowLayout {
