...
//        view.layer.shadowOpacity = 1
    ...
    lazy var discloseButton: SportivinieKartiCommonB = .init(style: .custom(buttonAppearance))

    lazy var optionsTableView: UITableView = { tableView in
        tableView.register(SportivinieKartiOptionTVC.self, forCellReuseIdentifier: SportivinieKartiOptionTVC.className)
...
extension SportivinieKartiOptionV: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let chislo5 = chislo1 * 2
        let chislo6 = chislo2
        let cell = tableView.dequeueReusableCell(withIdentifier: SportivinieKartiOptionTVC.className, for: indexPath) as? SportivinieKartiOptionTVC
