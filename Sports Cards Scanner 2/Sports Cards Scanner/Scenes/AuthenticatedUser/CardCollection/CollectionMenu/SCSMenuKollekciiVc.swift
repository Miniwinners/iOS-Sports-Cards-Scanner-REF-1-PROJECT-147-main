...
final class SportivinieKartiMenuKollekciiVc: UIViewController {
    ...
    lazy var collectionMenuView: SportivinieKartiMenuV = .init()
...
private extension SportivinieKartiMenuKollekciiVc {
    ...
    func postavitVid() {
        ...
        menuCollectionView.register(SportivinieKartiMSwitchC.self, forCellWithReuseIdentifier: SportivinieKartiMSwitchC.className)
...
extension SportivinieKartiMenuKollekciiVc: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch menuItem {
        case .showTotalPrice:
            let switchableCell = collectionView.dequeueReusableCell(withReuseIdentifier: SportivinieKartiMSwitchC.className, for: indexPath) as? SportivinieKartiMSwitchC
        ...
        default:
            let selectableCell = collectionView.dequeueReusableCell(withReuseIdentifier: SportivinieKartiMSelectC.className, for: indexPath) as? SportivinieKartiMSelectC
...
extension SportivinieKartiMenuKollekciiVc: UICollectionViewDelegate {
