...
final class SportivinieKartiPricingRB: UIButton {

    private var priceButtonType: ButtonTypeReport!
    lazy var graderPriceView: SportivinieKartiPRBGPV = .init(type: priceButtonType)
    lazy var noPriceView: SportivinieKartiPRBNPV = .init(type: priceButtonType)
    lazy var customPriceView: SportivinieKartiPRBCPV = .init(type: priceButtonType)
...
private extension SportivinieKartiPricingRB {
