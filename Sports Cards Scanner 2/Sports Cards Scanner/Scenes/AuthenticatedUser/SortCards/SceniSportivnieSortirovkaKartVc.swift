...
final class SportivinieKartiSortirovkaKartVc: UIViewController {

    weak var delegate: SportivinieKartiSortirovkaKartVcDelegat?
...
private extension SportivinieKartiSortirovkaKartVc {
    func postavitVid() {
        ...
        sortOptionsTableView.register(SportivinieKartiSortirovkaKartTCL.self, forCellReuseIdentifier: SportivinieKartiSortirovkaKartTCL.className)
...
extension SportivinieKartiSortirovkaKartVc: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: SportivinieKartiSortirovkaKartTCL.className, for: indexPath) as? SportivinieKartiSortirovkaKartTCL
...
extension SportivinieKartiSortirovkaKartVc: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        tableView.deselectRow(at: indexPath, animated: true)

        let oldCheckedCellIndexPath = self.indexPuti(of: newSelectedSortOption)
        let oldCheckedCell = tableView.cellForRow(at: oldCheckedCellIndexPath) as? SportivinieKartiSortirovkaKartTCL
        let newCheckedCell = tableView.cellForRow(at: indexPath) as? SportivinieKartiSortirovkaKartTCL
...
extension SportivinieKartiSortirovkaKartVc: SportivinieKartiSwaipProtocol {
