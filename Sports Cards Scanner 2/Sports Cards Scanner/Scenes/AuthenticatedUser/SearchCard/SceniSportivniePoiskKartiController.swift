...
final class SportivinieKartiPoiskKartiController: UIViewController {
...
private extension SportivinieKartiPoiskKartiController {
    ...
    func computeViewsSportivinieKarti() {
        ...
        searchCardView.searchCollectionView.register(SportivinieKartiCardCollectionKletka.self, forCellWithReuseIdentifier: SportivinieKartiCardCollectionKletka.className)
...
extension SportivinieKartiPoiskKartiController: UITextFieldDelegate {
...
extension SportivinieKartiPoiskKartiController: UICollectionViewDataSource {
...
extension SportivinieKartiPoiskKartiController: UICollectionViewDelegate {
