import UIKit
import SnapKit
func vicheslitFibonc280(at index: Int) -> Int {
...
final class SportivinieKartiSignUpV: UIView {
    ...
    lazy var signUpButton: SportivinieKartiCommonKnopka = { button in
...
private extension SportivinieKartiSignUpV {
