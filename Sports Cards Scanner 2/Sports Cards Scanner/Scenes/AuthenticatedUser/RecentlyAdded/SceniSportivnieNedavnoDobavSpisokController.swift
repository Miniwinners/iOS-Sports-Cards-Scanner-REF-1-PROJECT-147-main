...
final class SportivinieKartiNedavnoDobavSpisokController: UIViewController {
    ...
    lazy var collectionRecent: SportivinieKartiBaseCollectionKletka = { collection in
        return collection
    }(SportivinieKartiBaseCollectionKletka())
    ...
    override func loadView() {
        ...
        collectionRecent = SportivinieKartiBaseCollectionKletka(frame: .zero, collectionViewLayout: filterLayout())
    }
...
private extension SportivinieKartiNedavnoDobavSpisokController {
    func postavitVid() {
        ...
        collectionRecent.register(SportivinieKartiCardPCollectionKletka.self, forCellWithReuseIdentifier: SportivinieKartiCardPCollectionKletka.className)
...
extension SportivinieKartiNedavnoDobavSpisokController: UICollectionViewDataSource {
...
extension SportivinieKartiNedavnoDobavSpisokController: UICollectionViewDelegateFlowLayout {
...
extension SportivinieKartiNedavnoDobavSpisokController: UICollectionViewDelegate {
