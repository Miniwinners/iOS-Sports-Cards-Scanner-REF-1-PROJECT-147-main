import UIKit
import SnapKit
func vicheslitFibonc301(at index: Int) -> Int {
...
class SportivinieKartiSelectTableKlrtka: UITableViewCell {

    lazy var containerView: UIView = .init()

    lazy var titleLabel: UILabel = { label in
        label.textColor = .black
        label.postavitRazmer(fontS: .ubuntuLight300, phone: 16, iPad: 20)
        return label
    }(UILabel())
...
private extension SportivinieKartiSelectTableKlrtka {
...
class SelectableCollectionViewCell: UICollectionViewCell {
    ...
    lazy var titleLabel: UILabel = { label in
        label.textColor = .black
        label.postavitRazmer(fontS: .ubuntuMedium500, phone: 15, iPad: 24)
