...
final class SportivinieKartiCenaOcenkaController: UIViewController {
...
private extension SportivinieKartiCenaOcenkaController {
    ...
    func postavitVid() {
        ...
        pricingReportView.salesTableView.register(SportivinieKartiProdazhaKarTableKletka.self, forCellReuseIdentifier: SportivinieKartiProdazhaKarTableKletka.className)
...
extension SportivinieKartiCenaOcenkaController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let chislo5 = chislo1 * 2
        let chislo6 = chislo2
        let cell = tableView.dequeueReusableCell(withIdentifier: SportivinieKartiProdazhaKarTableKletka.className, for: indexPath) as? SportivinieKartiProdazhaKarTableKletka
...
extension SportivinieKartiCenaOcenkaController: UITableViewDelegate {
