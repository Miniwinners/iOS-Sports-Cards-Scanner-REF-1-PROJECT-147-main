...
final class SportivinieKartiKategoriiKartVC: UIViewController {
...
private extension SportivinieKartiKategoriiKartVC {
    func podgotovitRandomnoeDeiistvie() {
        let actions = [ { print("Привет!") }, { print("Как дела?") }, { print("Случайное число: \(Int.random(in: 1...100))") }, { print("Сегодня \(Date())") }
        ]
    ...
    func computeViewsSportivinieKarti() {
        ...
        collectionCategory.register(SportivinieKartiCardCVC.self, forCellWithReuseIdentifier: SportivinieKartiCardCVC.className)
...
extension SportivinieKartiKategoriiKartVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        _ = chislo1 * 2
        _ = chislo2
        let cell = collectionCategory.dequeueReusableCell(withReuseIdentifier: SportivinieKartiCardCVC.className, for: indexPath) as? SportivinieKartiCardCVC
...
extension SportivinieKartiKategoriiKartVC: UICollectionViewDelegate {
