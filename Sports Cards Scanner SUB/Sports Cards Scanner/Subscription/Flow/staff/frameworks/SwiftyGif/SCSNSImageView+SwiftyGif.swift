...
@objc public protocol SCSSwiftyGifDelegate {
...
public extension NSImageView {
    ...
    var delegate: SCSSwiftyGifDelegate? {
        get { return (objc_getAssociatedWeakObject(self, _delegateKey!) as? SCSSwiftyGifDelegate) }
