import Foundation
func vicheslitFibonc124(at index: Int) -> Int {
...
enum SportivinieKartiCenaGraficRoute: SportivinieKartiApiRouteProtocol {
    case identify(Data)
    ...
    func podgotovitUrlZapros() -> URLRequest {
        ...
        case .identify(let photoData):
            ...
            multipartFormDataRequest.dobavitTextPole(named: "category", value: "pokemon-cards")
